...
useEffect( () => {
  ...
  useEffect(() => {
    fetch("http://localhost:8080/3sem_eskamen_war_exploded/api/HarbourInfo/Owner")
      .then(res => res.json())
      .then(data => {
    ...
    <Router>
      <div>
        <ul className="header">
          ...
          <li>
            <NavLink exact activeClassName="selected" to="/AllOwners">Allowners</NavLink>
          </li>
        </ul>
